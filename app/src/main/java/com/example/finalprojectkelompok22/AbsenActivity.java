...
public class AbsenActivity extends AppCompatActivity {
    ...
    private void getLocation() {
        ...
        fusedLocationClient.getLastLocation()
                ...
                .addOnFailureListener(e -> Toast.makeText(this,"Gagal mendapatkan lokasi", Toast.LENGTH_SHORT));
    }

    private void submitAttendance() {
        if(photoBitmap == null) {
            Toast.makeText(this, "Silahkan ambil foto sebelum mengirim absensi", Toast.LENGTH_SHORT).show();
            return;
        }
